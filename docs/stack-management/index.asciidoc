...
= Manage your Elastic Stack from Kibana
...
include::{kib-repo-dir}/user/monitoring/index.asciidoc[]

include::{kib-repo-dir}/user/management.asciidoc[]

include::{kib-repo-dir}/user/troubleshooting/index.asciidoc[]
